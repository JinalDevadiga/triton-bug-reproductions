...
| [#4362](issue_4362/) | TD | TD | TD |
| [#4736](issue_4736/) | TD | TD | TD |
| [#4233](issue_4233/) | TD | TD | TD |
...
```bash
# General environment (Triton 3.6.0) — for issues #8311
conda create -n triton-bugs python=3.12 -y
conda activate triton-bugs
pip install torch==2.4.0
pip install triton

# Older environment (Triton 3.0.0) — for issues #7402, #7264
conda create -n triton-bugs python=3.12 -y
conda activate triton-bugs
pip install torch==2.4.0
...
- Issue #8311 requires an sm90+ GPU (H100 or RTX 5090) to observe wrong output at
  runtime. On sm75 (MX450), the `reproduce.py` compiles the kernel and dumps the TTGIR,
